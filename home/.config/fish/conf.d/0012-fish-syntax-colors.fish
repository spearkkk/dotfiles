...
#
# Make the prompt editor feel more colorful while keeping command tokens,
# arguments, options, strings, and operators visually distinct.
set -g fish_color_normal       (__fish_theme_color "$__COLOR_FG" normal)
set -g fish_color_command      --bold (__fish_theme_color "$__COLOR_SYNTAX_FUNCTION" blue)
set -g fish_color_keyword      --bold (__fish_theme_color "$__COLOR_SYNTAX_KEYWORD" magenta)
set -g fish_color_param        (__fish_theme_color "$__COLOR_BRIGHT_CYAN" cyan)
set -g fish_color_option       --bold (__fish_theme_color "$__COLOR_SYNTAX_TYPE" yellow)
...
set -g fish_color_operator     --bold (__fish_theme_color "$__COLOR_SYNTAX_OPERATOR" cyan)
...
set -g fish_color_error        --bold (__fish_theme_color "$__COLOR_ERROR" red)

# Paths, history, autosuggestions, and selection.
set -g fish_color_valid_path        --underline (__fish_theme_color "$__COLOR_BRIGHT_BLUE" blue)
set -g fish_color_autosuggestion    (__fish_theme_color "$__COLOR_FG_SUBTLE" brblack)
set -g fish_color_history_current   --bold (__fish_theme_color "$__COLOR_MATCH" yellow)
...
set -g fish_pager_color_completion    (__fish_theme_color "$__COLOR_BRIGHT_CYAN" cyan)
