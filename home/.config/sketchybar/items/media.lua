...
local CACHE_TSV = paths.media_tsv
local REQUEST_FILE = paths.media_refresh_request
...
local function toggle_play_pause()
  ...
  os.execute("("
    .. utils.shell_quote(NP_BIN)
    .. " togglePlayPause >/dev/null 2>&1; touch "
    .. utils.shell_quote(REQUEST_FILE)
