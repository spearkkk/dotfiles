...
local palette_data = require("config.theme.simhae_palette")
local palettes = palette_data.palettes or {}
local default_variant = palette_data.main or "pelagic"
...
local function resolve_opts(opts)
  opts = opts or {}
  return {
    variant = opts.variant or vim.g.simhae_variant or default_variant,
