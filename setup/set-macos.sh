...
# Keyboard: use key repeat instead of press-and-hold accent picker.
...
# Dialogs: expand save panels by default.
defaults write NSGlobalDomain NSNavPanelExpandedStateForSaveMode -bool true
# Dialogs: expand newer save panels by default.
defaults write NSGlobalDomain NSNavPanelExpandedStateForSaveMode2 -bool true
# Dialogs: expand print panels by default.
defaults write NSGlobalDomain PMPrintingExpandedStateForPrint -bool true
# Dialogs: expand newer print panels by default.
defaults write NSGlobalDomain PMPrintingExpandedStateForPrint2 -bool true
# Documents: save new documents to local disk instead of iCloud by default.
...
# Finder: show folders first when sorting by name.
defaults write com.apple.finder _FXSortFoldersFirst -bool true
# Finder: disable warning before changing a file extension.
defaults write com.apple.finder FXEnableExtensionChangeWarning -bool false

# Desktop Services: avoid writing .DS_Store files on network volumes.
defaults write com.apple.desktopservices DSDontWriteNetworkStores -bool true
# Desktop Services: avoid writing .DS_Store files on USB volumes.
defaults write com.apple.desktopservices DSDontWriteUSBStores -bool true

# Screenshots: save screenshots as PNG.
defaults write com.apple.screencapture type -string "png"

# Time Machine: do not prompt to use new disks for backup.
...
echo "[NEXT] Log out and log back in for disabling 'Displays have separate Spaces' to take effect."
